...
export const reducer = (state = initialState, action) => {
    ...
    switch (type) {
        ...
        // Delete Course
        case profileActions.DELETE_COURSE_REQUEST:
            return {
                ...state,
                loading: true
            };
        case profileActions.DELETE_COURSE_SUCCESS:
            return {
                ...state,
                loading: false,
                profile: payload.profile
            };
        case profileActions.DELETE_COURSE_FAILURE:
            return {
                ...state,
                loading: false,
                errorMessage: payload.error
        ...
        // Add Course
        case profileActions.ADD_COURSE_REQUEST:
            return {
                ...state,
                loading: true
            };
        case profileActions.ADD_COURSE_SUCCESS:
            return {
                ...state,
                loading: false,
                profile: payload.profile
            };
        case profileActions.ADD_COURSE_FAILURE:
            return {
                ...state,
                loading: false,
                errorMessage: payload.error
